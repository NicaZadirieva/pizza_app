...
import { PopularMenuItemProps } from './PopularMenuItem.props';
import styles from './index.module.css';


export const PopularMenuItem = ({ pizzaName, className, pizzaImgPath, filling, availableSizes, calculatedPrice, ...props }: PopularMenuItemProps) => {
	return (
